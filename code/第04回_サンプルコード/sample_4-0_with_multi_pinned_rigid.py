...
for k in range(N_rigids):
    if k == 0:
        rigids_pset[k] = create_rectangle(0.0,0.41,0.34,0.1)
    elif k <= 2:
        rigids_pset[k] = create_rectangle(-0.28+0.56*(k-1),0.2,0.34,0.1) # -0.3 0.3
    elif k <= 5:
        rigids_pset[k] = create_rectangle(-0.56+0.56*(k-3),-0.01,0.34,0.1) # -0.6 0.0 0.6
